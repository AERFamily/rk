    ...
    validateEmailRequest: (name, email, subject, message) => {
        ...
        return {
            ...
            bundle: {
                ...
                custom_source_name: "Rama Kant Portfolio"
            }
        }
    }
}
...
const analytics = {
     ...
     */
    reportVisit: async() => {
        await fetch("https://admin.ramakantsingh.com/api/analytics/mock", {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
                params: {
                    url: utils.url.getRootLocation(),
                    template_id: "ramakant-portfolio"
                }
            })
        })
    }
