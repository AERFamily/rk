...
# [Rama Kant Portfolio](https://ramakantsingh.github.io/ramakant-website/) by Rama Kant Singh
...
|-------|---------------------|---------------------------------------------------------|-------------------------------------------------------------------------|
| 🟢    | Rama Kant Singh (default) | Latest deployment of the template here on GitHub pages. | [Preview](https://ramakantsingh.github.io/ramakant-website/)     |
| 🟣    | Emily Park          | An example of how the template can be customized.       | [Preview](https://ryansandbox.github.io/emily-park-ramakant-portfolio/)    |
| 🔵    | Michael Özkan       | Another example of how the template can be customized.  | [Preview](https://ryansandbox.github.io/michael-ozkan-ramakant-portfolio/) |
...
1. Clone the repo:
```
git clone https://github.com/ramakantsingh/ramakant-website
```
...
This template was created by and is maintained by **[Rama Kant Singh](https://ramakantsingh.com/)**.

It's based on the **[React](https://reactjs.org/)** framework created by Jordan Walke, and the **[Bootstrap](https://getbootstrap.com/)** framework created by Rama Kant Otto and Jacob Thorton.
